...
void energy_resolution_fit3() {
  
   //gStyle->SetOptFit(kFALSE);	
   gStyle->SetOptFit(1);	
   TCanvas *c1 = new TCanvas("c1","Energy Resolution 3 GeV",200,10,700,500);
   FILE *f = fopen("energy_resolution_sigma_blockM4A.dat","r");
   ...
   gr = new TGraph(n,adc,energy);
   TF1 *pfit1 = new TF1("fitfunction",fitfunction,0.5,5.5,2);
   pfit1->SetParameters(0.00,1.00);
...
//   axis->SetLimits(-5.,5.);
   gr->GetHistogram()->SetMaximum(18.0);
